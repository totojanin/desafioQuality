...
public class FlightControllerTest {
    ...
    @BeforeEach
    void setUp() {
        flightController = new FlightController(flightService, bookingService);
    }
    ...
    public void reserveBooking() throws InvalidInputException, IOException, ParseException {
        ...
        ResponseEntity<BookingFlightResponseDTO> responseBooking = flightController.flightReservation(bookingRequest);
    ...
    public void getBookingDateFromException() throws Exception {
        ...
        ResponseEntity thrown = flightController.flightReservation(bookingRequest);
